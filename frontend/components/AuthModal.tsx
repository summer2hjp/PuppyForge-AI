      ...
      <div className="relative w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 space-y-6 animate-in zoom-in-95 duration-200">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 py-2 bg-white hover:bg-zinc-100 text-zinc-900 rounded-lg text-sm font-medium transition-colors border border-zinc-200"
          >
